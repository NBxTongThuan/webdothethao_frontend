...
const EditCategory: React.FC<ModalProps> = (props) => {
    ...
    useEffect(() => {
        ...
        setOldCategoryName(props.category.categoriesName);
    }, [props.category]);
    ...
    const handleSubmit = async () => {
        ...
        const category = {
            categoryId: props.category.categoriesId,
        ...
        <ConfigProvider getPopupContainer={() => document.body}>
            ...
            >
                <div className="p-6">
                    ...
                    <p className="text-gray-600 text-center mb-6">Bạn có chắc chắn muốn cập nhật danh mục này không?</p>
                </div>
            </Modal>
            <AnimatePresence>
                <motion.div
                            ...
                            <div className="bg-gradient-to-br from-white to-gray-50 rounded-lg shadow-lg p-8 border border-gray-100">
                                <div className="flex justify-between items-center mb-6">
                                    <div className="flex items-center">
                                        ...
                                        <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Sửa danh mục</h1>
                                    </div>
                                    <button
                                ...
                                <div className="space-y-4 form-edit-category">
                                    <div>
