...
const AddType: React.FC<ModalProps> = (props) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok == true) {
                toast.success("Thêm thể thành công");
                props.onClose();
                setTimeout(() => {
                        ...
                        <div className="bg-gradient-to-br from-white to-gray-50 rounded-lg shadow-lg p-8 border border-gray-100">
                            <div className="flex justify-between items-center mb-6">
                                <div className="flex items-center">
                                    ...
                                    <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Thêm thể loại mới</h1>
                                </div>
                                <button
